...
public:
  ...
  bool get_box_pose_wrt_world(int stationNum, geometry_msgs::PoseStamped &box_pose_wrt_world);
  bool get_box_pose_wrt_world_1(geometry_msgs::PoseStamped &box_pose_wrt_world);
  ...
  bool post_dropoff_check(vector<osrf_gear::Model> desired_models_wrt_world,vector<osrf_gear::Model> &misplaced_models_desired_coords, vector<osrf_gear::Model> &misplaced_models_actual_coords, int cam_num);
  bool pre_dropoff_check(inventory_msgs::Part part, osrf_gear::Model model_actual, osrf_gear::Model model_desired, int cam_num);
...
private:
    ...
    void box_camera_callback_2(const osrf_gear::LogicalCameraImage::ConstPtr & image_msg);
    ...
    ros::Subscriber box_camera_subscriber_2_;
